      ...
      body: Column(children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            image: DecorationImage(
              image: AssetImage('assets/images/gandrung.jpeg'),
              fit: BoxFit.cover,
            ),
          ),
        ),
        Container(
            ...
            child: Card(
              ...
              Row(children: [
                Text('Nama        : Chindi Fidaro aini', style: TextStyle(fontWeight: FontWeight.bold)),
              ]),
              Row(children: [
                Text('TTL            : Banyuwangi, 22 Februari 2003 ', style: TextStyle(fontWeight: FontWeight.bold)),
              ]),
              Row(children: [
              ...
              Row(children: [
                Text('Alamat       : Dsn.Krajan Tamansari 01/02 Kec.Licin', style: TextStyle(fontWeight: FontWeight.bold)),
              ]),
              Row(children: [
                Text('No. HP      : 085804366621', style: TextStyle(fontWeight: FontWeight.bold)),
              ]),
              Row(children: [
                Text('Status        : Jomblo', style: TextStyle(fontWeight: FontWeight.bold)),
              ]),
            ]))),
      ]),
    );
